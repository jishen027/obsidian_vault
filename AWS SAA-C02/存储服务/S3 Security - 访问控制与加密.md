...
> **S3 安全**横跨身份访问控制、资源策略、网络隔离、静态/传输加密和审计合规等多个维度，是 SAA-C02 考试中最高频的主题之一。本笔记深入展开 [[S3 - Object Storage]] 中"安全性"一节未详述的机制。
>
> 相关文档：[[S3 - Object Storage]] | [[IAM]] | [[KMS]] | [[虚拟私有云 - VPC]] | [[CloudTrail]]
